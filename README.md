...
#pr2_16_diff_betw_odd_and_even_cubes
Разность сумм нечётных и чётных кубов. На вход подаётся число 𝑛 ∈ N : 𝑛 ≤ 2147483647, а также 𝑛 чисел 𝑥𝑖 ∈ Z : |𝑥𝑖| ≤ 2147483647 для любого целого 𝑖 от 1 до 𝑛. Вывести  сумму (-1) в степени (i+1) умноженную на число в кубе.
